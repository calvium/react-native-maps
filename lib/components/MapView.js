...
const propTypes = {
  ...
  /**
   * Define a camera boundary that will always be present in the map
   * @platform ios
   */
  cameraBoundaryRegion: PropTypes.shape({
  ...
  /**
   * Define a maximum and minimum zoom defined by the distance of the camera to the center
   * @platform ios
   */
  cameraZoom: PropTypes.shape({
    minCenterCoordinateDistance: PropTypes.number.isRequired,
    maxCenterCoordinateDistance: PropTypes.number.isRequired,
  }),
};
